...
export const INITIAL_BOOKINGS: Booking[] = [
  { id: 'bk1', patientId: 'p1', therapistId: 't1', branchId: 'b1', therapyType: 'Fisioterapi', bookingDate: new Date().toISOString().split('T')[0], startTime: '09:00', endTime: '10:00', status: 'COMPLETED', patient: { name: 'Sarah Johanna' }, therapist: { name: 'dr. Maya Lestari, Ftr' }, room: { name: 'Ruang 1' }, branch: { name: 'Jakarta' } },
  { id: 'bk2', patientId: 'p2', therapistId: 't2', branchId: 'b1', therapyType: 'Terapi Wicara', bookingDate: new Date().toISOString().split('T')[0], startTime: '10:30', endTime: '11:30', status: 'IN_PROGRESS', patient: { name: 'Bima Aditya' }, therapist: { name: 'Sinta Rahma' }, room: { name: 'Ruang 2' }, branch: { name: 'Jakarta' } },
  { id: 'bk3', patientId: 'p3', therapistId: 't4', branchId: 'b2', therapyType: 'Okupasi Terapi', bookingDate: new Date().toISOString().split('T')[0], startTime: '13:00', endTime: '14:00', status: 'CONFIRMED', patient: { name: 'Nadira Putri' }, therapist: { name: 'Hana Pratiwi' }, room: { name: 'Ruang 1' }, branch: { name: 'Bandung' } },
  { id: 'bk4', patientId: 'p4', therapistId: 't5', branchId: 'b3', therapyType: 'Rehab Medik', bookingDate: new Date().toISOString().split('T')[0], startTime: '14:30', endTime: '15:30', status: 'CONFIRMED', patient: { name: 'Rafi Mustofa' }, therapist: { name: 'Rendra Saputra' }, room: { name: 'Ruang 3' }, branch: { name: 'Surabaya' } },
  { id: 'bk5', patientId: 'p5', therapistId: 't1', branchId: 'b1', therapyType: 'Tumbuh Kembang', bookingDate: new Date().toISOString().split('T')[0], startTime: '15:00', endTime: '16:00', status: 'CONFIRMED', patient: { name: 'Lintang Kusuma' }, therapist: { name: 'dr. Maya Lestari, Ftr' }, room: { name: 'Ruang 4' }, branch: { name: 'Jakarta' } },
  { id: 'bk6', patientId: 'p6', therapistId: 't7', branchId: 'b1', therapyType: 'Fisioterapi', bookingDate: new Date().toISOString().split('T')[0], startTime: '16:00', endTime: '17:00', status: 'CONFIRMED', patient: { name: 'Arjun Prabowo' }, therapist: { name: 'Rizki Pratama' }, room: { name: 'Ruang 1' }, branch: { name: 'Jakarta' } },
  { id: 'bk7', patientId: 'p7', therapistId: 't2', branchId: 'b2', therapyType: 'Terapi Wicara', bookingDate: new Date().toISOString().split('T')[0], startTime: '10:00', endTime: '11:00', status: 'COMPLETED', patient: { name: 'Mila Santoso' }, therapist: { name: 'Sinta Rahma' }, room: { name: 'Ruang 2' }, branch: { name: 'Bandung' } },
  { id: 'bk8', patientId: 'p8', therapistId: 't5', branchId: 'b4', therapyType: 'Rehab Medik', bookingDate: new Date().toISOString().split('T')[0], startTime: '11:00', endTime: '12:00', status: 'CONFIRMED', patient: { name: 'Doni Hermawan' }, therapist: { name: 'Rendra Saputra' }, room: { name: 'Ruang 1' }, branch: { name: 'Tangerang' } },
  { id: 'bk9', patientId: 'p9', therapistId: 't3', branchId: 'b3', therapyType: 'Konseling', bookingDate: new Date().toISOString().split('T')[0], startTime: '13:30', endTime: '14:30', status: 'CONFIRMED', patient: { name: 'Citra Dewi' }, therapist: { name: 'Dimas Aditya' }, room: { name: 'Ruang 2' }, branch: { name: 'Surabaya' } },
  { id: 'bk10', patientId: 'p10', therapistId: 't4', branchId: 'b2', therapyType: 'Okupasi Terapi', bookingDate: new Date().toISOString().split('T')[0], startTime: '14:00', endTime: '15:00', status: 'CONFIRMED', patient: { name: 'Evan Pratama' }, therapist: { name: 'Hana Pratiwi' }, room: { name: 'Ruang 3' }, branch: { name: 'Bandung' } },
];
